...
const DICT: Record<Lang, Dictionary> = {
  ...
  "zh-tw": {
    ...
    footer: {
      blurb: "覆蓋全澳的清晰、審慎法律意見——從不動產與商業事務，到遺產、智慧財產、刑事、移民及公證服務。",
      ...
      australiaWide: "服務全澳",
      contactTitle: "聯絡方式",
      address: "維多利亞州墨爾本市 Little Collins St 530 號 1508 室，郵遞區號 3000",
    ...
    summaries: {
      ...
      "intellectual-property": "商標、專利、著作權與外觀設計——從首次註冊到國際申請與維權。",
    ...
    pages: {
      home: {
        ...
        testimonials: [
          ...
          { quote: "對細節把握精準，溝通也很輕鬆。我會毫不猶豫地推薦他們。", name: "D. Brown", detail: "智慧財產" },
        ],
        readyEyebrow: "與我們聯絡",
