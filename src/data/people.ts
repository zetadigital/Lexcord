...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    phone: FIRM_PHONE,
    qualifications: [
      "Juris Doctor (expected August 2026, WAM 76.58) — Monash University",
    ...
    qualificationsZh: [
      "法学博士 Juris Doctor（预计 2026 年 8 月完成，加权平均分 76.58）— 莫纳什大学",
      "社会工作研究硕士 — 昆士兰大学",
      "法学学士（主修：犯罪学）— 中国人民公安大学，北京",
    ],
    bio: [
      "Taylor is a Paralegal at Lexcord and is currently completing her Juris Doctor at Monash University (expected August 2026, WAM 76.58). She brings a distinctive multidisciplinary background — combining legal training in both China and Australia with a Master of Social Work and over eight years of frontline community services experience.",
      "At Lexcord, Taylor assists solicitors across a broad range of matters, including drafting and reviewing legal documents and correspondence, conducting legal research, liaising with clients, barristers and courts, and managing case files through the LEAP and Monday platforms. Her prior paralegal experience spans community legal services in regional Victoria and private practice in Melbourne, providing exposure to diverse client needs and court procedures.",
    ...
    bioZh: [
      "张彦伊（Taylor）担任律和律师助理，同时在莫纳什大学攻读法学博士（JD）课程（预计 2026 年 8 月完成，加权平均分 76.58）。她拥有跨学科的多元背景，融合了中澳两国法学训练、社会工作硕士学位，以及逾八年的社区服务一线经验。",
      "在律和，她协助律师处理各类事务，包括起草与审阅法律文书及往来函件、开展法律研究、联络客户与大律师及法院，并通过 LEAP 与 Monday 平台进行案件管理。此前，她曾在维多利亚州社区法律服务机构及墨尔本私人律师事务所担任律师助理，积累了丰富的实务经验。",
      "张彦伊的社会工作背景赋予她以客户为中心的同理心视角，尤其擅长处理涉及家庭、弱势群体及复杂个人处境的法律事务。",
    ],
  },
  {
    slug: "carol-ma",
    name: "Carol Ma",
    role: "Lawyer (China) & Paralegal",
    roleZh: "律师（中国）兼律师助理",
    ...
    qualifications: [
      ...
      "Bachelor of Laws (GPA 3.61/4.0) — Guizhou University",
    ],
    qualificationsZh: [
      "法学硕士 — 悉尼大学",
      "法学学士（GPA 3.61/4.0，毕业论文：论《巴黎协定》下气候资金的来源）— 贵州大学",
    ],
    bio: [
      "Carol is a commercial and capital markets lawyer who brings extensive experience in Chinese and cross-border legal practice to Lexcord. She holds a Master of Law from the University of Sydney and a Bachelor of Laws from Guizhou University (GPA 3.61/4.0), and spent four years as a lawyer at Beijing Tongshang Law Firm (December 2021 – September 2025).",
      "At Beijing Tongshang, Carol advised on a broad range of commercial matters including securities issuance and IPO transactions (A-share and Hong Kong listings), private equity and M&A, and ongoing corporate advisory for listed and unlisted companies. Her work encompassed legal due diligence, drafting investment agreements, shareholder agreements and share transfer documents, regulatory compliance, and corporate governance.",
    ...
    bioZh: [
      "马菊鸿（Carol）是一位专注于商业及资本市场的律师，在中国及跨境法律实务方面积累了深厚经验。她持有悉尼大学法学硕士及贵州大学法学学士（GPA 3.61/4.0）学位，并于 2021 年 12 月至 2025 年 9 月在北京市通商律师事务所执业。",
      "在通商期间，Carol 参与了广泛的商业法律事务，涵盖证券发行与 IPO（A 股及港股上市）、私募股权融资与并购交易，以及为上市与非上市企业提供常年法律顾问服务。其工作内容包括法律尽职调查、起草投资协议、股东协议与股权转让文件，以及监管合规与公司治理。",
