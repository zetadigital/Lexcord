...
export const team: TeamMember[] = [
  {
    ...
    bioZh: [
      "Katherine 是 Lexcord 律师事务所的主任律师。她在澳大利亚及台湾均取得律师执照，同时也是认证调解员及台湾认证老龄化财务规划顾问——这一独特的资历组合，使她能够为需要应对复杂跨境法律挑战的客户提供专业服务。",
    ...
    bioZhTw: [
      "Katherine 是 Lexcord 律師事務所的主任律師。她在澳大利亞及台灣均取得律師執照，同時也是認可調解員及台灣認證老齡化財務規劃顧問——這一獨特的資歷組合，使她能夠為需要應對複雜跨境法律挑戰的客戶提供專業服務。",
  ...
  },
  {
    ...
    bioZh: [
      "Justin Ho 是一位澳大利亚执业律师，专注于知识产权法，并具备生物技术、分子生物学及生物化学等扎实的理科学术背景。他为个人及企业客户提供各类知识产权事务的专业法律建议，将深厚的技术积累与严谨的法律素养融入每一次委托服务中。",
    ...
    bioZhTw: [
      "Justin Ho 是一位澳大利亞執業律師，專注於知識產權法，並具備生物技術、分子生物學及生物化學等扎實的理科學術背景。他為個人及企業客戶提供各類知識產權事務的專業法律建議，將深厚的技術積累與嚴謹的法律素養融入每一次委託服務中。",
