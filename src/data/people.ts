...
export const team: TeamMember[] = [
  {
    ...
    bioZh: [
      "Katherine 是 Lexcord 律师事务所的主理律师。她在澳大利亚及台湾均取得律师执照，同时也是认证调解员及台湾认证老龄化财务规划顾问——这一独特的资历组合，使她能够为需要应对复杂跨境法律挑战的客户提供专业服务。",
    ...
    bioZhTw: [
      "Katherine 是 Lexcord 律師事務所的主理律師。她在澳大利亞及台灣均取得律師執照，同時也是認可調解員及台灣認證老齡化財務規劃顧問——這一獨特的資歷組合，使她能夠為需要應對複雜跨境法律挑戰的客戶提供專業服務。",
